...
public class MusicFragment extends BaseFragment implements MusicContract.View {
    ...
    public void initViews(View view) {
        ...
        //rv_music.setPadding(rv_music.getPaddingLeft(), paddingTop, rv_music.getPaddingRight(), rv_music.getPaddingBottom());

        rv_music.setHasFixedSize(true);
        rv_music.setLayoutManager(new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false));
        rv_music.setItemAnimator(new DefaultItemAnimator());

        rv_music.addOnScrollListener(new HidingScrollListener(getActivity()) {
...
//                    rv_music.scrollToPosition(mNewsListAdapter.getItemCount() - 1);
//                }
            }
