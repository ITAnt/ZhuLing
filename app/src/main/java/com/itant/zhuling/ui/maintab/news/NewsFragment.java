...
import com.itant.zhuling.ui.maintab.news.detail.NewsDetailActivity;
...
public class NewsFragment extends BaseFragment implements NewsContract.View {
    ...
    public void initViews(View view) {
        ...
        /*SlideInUpAnimator animator = new SlideInUpAnimator(new OvershootInterpolator(50f));
        rv_news.setItemAnimator(animator);
        rv_news.getItemAnimator().setMoveDuration(1000);*/
        rv_news.setItemAnimator(new SlideInUpAnimator(new OvershootInterpolator(1f)));
        ...
        //rv_news.setPadding(rv_news.getPaddingLeft(), paddingTop, rv_news.getPaddingRight(), rv_news.getPaddingBottom());
        ...
        rv_news.addOnScrollListener(new HidingScrollListener(getActivity()) {
...
//                    rv_news.scrollToPosition(mNewsListAdapter.getItemCount() - 1);
//                }
            }
